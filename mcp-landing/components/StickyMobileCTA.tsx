...
export default function StickyMobileCTA() {
  const { href, handleClick } = useWhatsAppCTA({
    ...
    ctaLabel: 'Quiero mi precio por WhatsApp',
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-brand-dark/95 backdrop-blur-md border-t border-white/10 p-3 shadow-[0_-4px_20px_rgba(0,0,0,0.3)] animate-slide-up">
      <a
        ...
        className="flex items-center justify-center gap-2 bg-brand-green text-white font-bold py-3.5 rounded-full text-base w-full hover:bg-brand-green-hover transition-colors animate-pulse-glow"
      >
