const photos = [
  ...
  { src: '/cocina-blanca.png', alt: 'Cocina blanca con bajo mesada y alacenas a medida', className: 'aspect-square' },
  { src: '/cocina-lineal.png', alt: 'Cocina lineal con muebles superiores en madera', className: 'md:col-span-2 aspect-[16/9]' },
  { src: '/cocina-barra.png', alt: 'Cocina con barra desayunadora y mesada de granito negro', className: 'md:col-span-3 aspect-[16/9] md:aspect-[21/9]' },
]
    ...
    <section className="px-5 py-20 md:py-28 bg-brand-card/40">
      <div className="max-w-6xl mx-auto">
        ...
        <h2 className="font-serif text-3xl md:text-4xl leading-tight mb-4">
          Cocinas que ya instalamos<br />en Santa Fe.
        </h2>
        <p className="text-brand-muted mb-10 max-w-lg">
          Fotos reales, sin renders: cocinas fabricadas e instaladas por MCP en
          hogares de Santa Fe y la regi&oacute;n.
        </p>
